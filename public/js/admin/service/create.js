        ...
        return `<div class="field-item card mt-3" data-field-index="${fieldIndex}">
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            <label for="name${fieldIndex}" class="col-sm-2 col-form-label">Name</label>
                            <div class="col-sm-8 col-lg-6">
                                <input type="text" class="form-control" id="name${fieldIndex}" placeholder="Name" name="fields[${fieldIndex}][name]">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="type${fieldIndex}" class="col-sm-2 col-form-label">Type</label>
                            <div class="col-sm-8 col-lg-6">
